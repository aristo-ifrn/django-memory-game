const HTMLElements = {
  ...
  loggedInput: document.querySelector("#logged"),
...
const tracks = {
  background: new Audio("/static/assets/audios/fighting.flac"),
  focus: new Audio("/static/assets/audios/focus.wav"),
  select: new Audio("/static/assets/audios/select.wav"),
  map: new Audio("/static/assets/audios/map.wav"),
};
...
const CARDSDATA = [
  { image: "/static/assets/images/colossus/avion.png", name: "Avion" },
  { image: "/static/assets/images/colossus/gaius.png", name: "Gaius" },
  { image: "/static/assets/images/colossus/pelagia.png", name: "Pelagia" },
  { image: "/static/assets/images/colossus/phaeda.png", name: "Phaeda" },
  { image: "/static/assets/images/colossus/quadratus.png", name: "Quadratus" },
  { image: "/static/assets/images/colossus/valus.png", name: "Valus" },
];
...
const generateCardHTML = ({ name, image }) => {
  ...
  cardHTML.innerHTML = `
      ...
      <div class="back">
        <img src="/static/assets/images/logo-alternative.png" alt="star wars icon" />
      </div>
    `;
  return cardHTML;
};
...
HTMLElements.homeButton.addEventListener("click", () => {
  redirectWithLoading(getRootUrl());
});
